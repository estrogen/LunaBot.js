...
module.exports = async (bot) => {
    console.log('[Luna]'.blue, `Username: ${bot.user.tag} (${bot.user.id})`.white);
    ...
    console.log('[Luna]'.blue,'Started refreshing application (/) commands.');
    await rest.put(
        Routes.applicationGuildCommands(process.env.client, process.env.guild),
        { body: bot.commandArray },
    );
    console.log('[Luna]'.blue,'Successfully reloaded application (/) commands.');
